...
export default function TermsConditions() {
  return (
    ...
    <div classname="termcondition-container">
        <h1 className='policesHeading'>Terms and conditions</h1> 
        <p>Last updated: December 31, 2023</p><br/>
        <p>Please read these terms and conditions carefully before using Our Service.</p><br/>
        <p>Welcome to the website of Dr. Ashu Garg, Diplomate American Board of Cosmetic Surgery, a world-renowned
            Cosmetic surgeon in Los Angeles, CA. Dr. Garg specializes in a wide range of cosmetic and aesthetic
            procedures, helping you achieve the shape you deserve. These Terms and Conditions govern your access to and
            use of this website and its associated services. By accessing or using this website, you agree to be bound
            by these Terms and Conditions. If you disagree with any part of these Terms and Conditions, you may not
        ...
        <ul classname="ulclass">
            ...
            <li>
                ...
                refers to Garg LLC, 4824 Sunnyslope Ave Unit 102 Sherman Oaks, CA 91423.
            </li>
            <li>
            ...
            <li>
                <strong>Website</strong> refers to Shape U Deserve, accessible from <a
                    href="https://www.shapeudeserve.com/">https://www.shapeudeserve.com/</a>
            </li>
            <li>
        ...
        <p>By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with
            any part of these Terms and Conditions then You may not access the Service.</p><br/>
        ...
        <p>These Terms and Conditions specifically apply to the services provided by Dr. Ashu Garg, a board-certified
        ...
        <p>The Company has no control over, and assumes no responsibility for, the content, privacy policies, or
            ...
            through any such web sites or services.</p><br/>
        <p>We strongly advise You to read the terms and conditions and privacy policies of any third-party web sites or
            services that You visit.
        </p><br/>
        <p>We specifically disclaim any responsibility for the content, privacy policies, or practices of any
            third-party websites or services, including those related to plastic surgery or cosmetic surgery.</p><br/>
        ...
        <p>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason
            whatsoever, including without limitation if You breach these Terms and Conditions.</p><br/>
        <p>Upon termination, Your right to use the Service will cease immediately.

        </p><br/>
        <h1>Limitation of Liability</h1><br/>
        <p>While Dr. Garg is a Diplomate American Board of Cosmetic Surgery, please note that notwithstanding any
            damages that You might incur, the entire liability of the Company and any of its suppliers under any
            provision of this Terms and Your exclusive remedy for all of the foregoing shall be limited to the amount
        ...
        <p>Some jurisdictions do not allow the exclusion of certain types of warranties or limitations on applicable
            ...
            extent enforceable under applicable law.</p><br/>
        <p>The information and services provided on this website are not intended as a substitute for professional
            medical advice, diagnosis, or treatment from a board-certified plastic surgeon.</p><br/>
        ...
        <h1>For European Union (EU) Users</h1><br/>
        ...
        <h1>United States Legal Compliance</h1><br/>
        ...
        <h1>Severability and Waiver</h1><br/>
        <h2>
            Severability
        </h2>
        ...
        <h1>Translation Interpretation</h1><br/>
        ...
        <p>By email: care@shapeudeserve.com

        </p><br/>
        <p>By visiting this page on our website: <a
                href="https://www.shapeudeserve.com/contact-us/">https://www.shapeudeserve.com/contact-us/</a>

        </p><br/>
        <p>By phone number: +1 424-666-1260</p><br/>
        <p>By mail: 435 N Bedford Dr Suite, 213 Beverly Hills CA 90210

        </p><br/>
        <p>Please note that Dr. Garg is available to discuss your specific cosmetic surgery or aesthetic goals during a
            consultation.
